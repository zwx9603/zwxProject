...
public class InstructionBean {
    ...
    private List<InstructionRecordBean> instructionRecordList   ; //调派指令记录

    private String instructionTypeCode; //  警情指令类型代码

    private String instructionTypeName; //  警情指令类型名称

    private String instructionCategoryCode; //   警情信息类别代码

    private String instructionCategoryName; //   警情信息类别名称
    ...
    public List<InstructionRecordBean> getInstructionRecordList() {
        return instructionRecordList;
    }

    public void setInstructionRecordList(List<InstructionRecordBean> instructionRecordList) {
    ...
    public String getInstructionCategoryName() {
        return instructionCategoryName;
    }
