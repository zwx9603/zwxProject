...
public class IncidentGuidanceInputInfo {
    ...
    private  DocumentSaveInputInfo documentSaveInputInfo ; //原火场文书入参
    ...
    public DocumentSaveInputInfo getDocumentSaveInputInfo() {
        return documentSaveInputInfo;
    }

    public void setDocumentSaveInputInfo(DocumentSaveInputInfo documentSaveInputInfo) {
        this.documentSaveInputInfo = documentSaveInputInfo;
    }
