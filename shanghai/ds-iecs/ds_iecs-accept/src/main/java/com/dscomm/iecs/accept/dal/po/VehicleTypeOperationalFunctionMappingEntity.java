...
@DynamicInsert(true)
@DynamicUpdate(true)
public class VehicleTypeOperationalFunctionMappingEntity extends BaseEntity {

    @Column(name = "ZZGNZDDM", length = 100)
    private String operationalFunctionCode; //作战功能字典代码
