...
public class LocaleBean extends BaseBean {
    ...
    private Long collectionTime;//采集时间
    ...
    private String weatherInformationName;//天气字典名称

    private String weatherTemperature;//气温

    private String windDirection;//风向

    private String windDirectionName;//风向

    private String windGrade;//风力等级代码

    private String windGradeName;//风力等级名称

    private String relativeHumidity;//相对湿度

    private String disasterGradeCode;//灾害等级代码

    private String disasterGradeName;//灾害等级名称
    ...
    private Integer whetherFileFeedback = 0   ; //是否为附件反馈 0文字反馈 1附件反馈 默认0 文字反馈
    ...
    public String getWeatherInformationName() {
        return weatherInformationName;
    }

    public void setWeatherInformationName(String weatherInformationName) {
        this.weatherInformationName = weatherInformationName;
    }
    ...
    public String getWindGradeName() {
        return windGradeName;
    }

    public void setWindGradeName(String windGradeName) {
        this.windGradeName = windGradeName;
    }
    ...
    public String getDisasterGradeName() {
        return disasterGradeName;
    }

    public void setDisasterGradeName(String disasterGradeName) {
        this.disasterGradeName = disasterGradeName;
    }
