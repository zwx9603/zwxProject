...
public class UdpFeedBackVO {
    ...
    private UdpFeedBackContentVO msgContent;
    ...
    @XmlTransient
    public UdpFeedBackContentVO getMsgContent() {
        return msgContent;
    }

    public void setMsgContent(UdpFeedBackContentVO msgContent) {
