 ...
 */
@Entity
@Table(name = "ZBZB_TZQCDY")
@DynamicInsert(true)
@DynamicUpdate(true)
public class SpecialEquipmentEntity extends BaseEntity {

    @Column(name = "QCID", length = 100)
    private String equipmentId; //器材ID

    @Column(name = "SFTZQC")
    private Short whetherSpecialEquipment; //是否特种器材
    ...
    public Short getWhetherSpecialEquipment() {
        return whetherSpecialEquipment;
    }

    public void setWhetherSpecialEquipment(Short whetherSpecialEquipment) {
        this.whetherSpecialEquipment = whetherSpecialEquipment;
    }
