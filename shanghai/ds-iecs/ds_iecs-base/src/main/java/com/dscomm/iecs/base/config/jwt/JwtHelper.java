...
//     * @Modified By:
//     */
//    public static String generateJWT(String userId, String userName, JwtConfigBean jwtConfigBean , String... identities   ) {
//        //签名算法，选择SHA-256
...
//        byte[] apiKeySecretBytes = DatatypeConverter.parseBase64Binary(jwtConfigBean.getSecret());
