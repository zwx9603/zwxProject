...
public class UdpPhoneVO {
    ...
    private UdpPhoneContentVO msgContent;
    ...
    @XmlTransient
    public UdpPhoneContentVO getMsgContent() {
        return msgContent;
    }

    public void setMsgContent(UdpPhoneContentVO msgContent) {
