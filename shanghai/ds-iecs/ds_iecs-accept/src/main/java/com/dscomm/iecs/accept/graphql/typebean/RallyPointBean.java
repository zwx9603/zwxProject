...
public class RallyPointBean {
    ...
    private List<RallyItemBean> rallyItemBeans ; //集结项信息
    ...
    public List<RallyItemBean> getRallyItemBeans() {
        return rallyItemBeans;
    }

    public void setRallyItemBeans(List<RallyItemBean> rallyItemBeans) {
        this.rallyItemBeans = rallyItemBeans;
    }
}
