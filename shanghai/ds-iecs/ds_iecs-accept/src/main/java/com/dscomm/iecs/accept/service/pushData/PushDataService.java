...
public interface PushDataService {
     ...
     * 车辆状态 变更
     * */
    Boolean pushVehicleStatusChange( String incidentId , String handleId ,   String  vehicleId  ,
                                     String vehicleStatusCode   , Map<String, String > otherParams )  ;

    /**
     * 车辆状态 变更
     * */
    Boolean pushVehicleStatusChange( String incidentId , String handleId ,   List<String>  vehicleId  ,
                                     String vehicleStatusCode   , Map<String, String > otherParams )  ;
