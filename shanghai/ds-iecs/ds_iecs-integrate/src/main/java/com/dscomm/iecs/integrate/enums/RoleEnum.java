package com.dscomm.iecs.integrate.enums;
...
public enum RoleEnum implements BasicEnumNumber {
    // type(code,name)
    AGENT_PERSONROLE_CALLTAKING(55, "接警员"),
    ...
    AGENT_PERSONROLE_CALLTAKING_SUPERVISOR(60, "接警班长"),
    AGENT_PERSONROLE_DISPATCH_SUPERVISOR(61, "处警班长"),
    AGENT_PERSONROLE_SENIOR_DISPATCH(61, "高级处警员"),
