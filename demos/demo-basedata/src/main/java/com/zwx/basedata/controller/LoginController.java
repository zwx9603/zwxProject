...
public class LoginController {
    ...
    public ResultVo toLogin(@RequestBody UserEntity user){
         ...
         * */
        UserEntity userEntity = userService.queryUserInfo(user.getUserName(), user.getPassdWord());
        if(userEntity != null){
            return new ResultVo(null,"登录成功");
        }else {
            return new ResultVo(null,"登录失败");
        }
    }
}
