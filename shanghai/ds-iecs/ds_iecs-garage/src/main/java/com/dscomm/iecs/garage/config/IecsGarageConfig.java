package com.dscomm.iecs.garage.config;
...
public class IecsGarageConfig {

    @Bean("initializeTaskFactory")
    public TaskFactory initializeTaskFactory(ApplicationContext context) {
        TaskFactory taskFactory = new TaskFactory();
        BaseTask mobileVideoUdpTask=context.getBean("udpTask", BaseTask.class);
        taskFactory.addSingleAsyncTask(mobileVideoUdpTask);
