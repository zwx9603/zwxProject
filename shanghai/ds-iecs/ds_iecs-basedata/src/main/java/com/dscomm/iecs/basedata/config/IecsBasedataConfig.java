package com.dscomm.iecs.basedata.config;
...
public class IecsBasedataConfig {



    @Bean(name = "baseTaskFactory")
    public TaskFactory getAcceptTaskFactory(ApplicationContext context) {
        TaskFactory factory = new TaskFactory();
        BaseTask basedataCacheTask = context.getBean("initializeDataCacheTask", BaseTask.class);
        factory.addSingleAsyncTask(basedataCacheTask);
        factory.runSerialTasks();
        return factory;
    }
