...
public class UdpIncidentReceiveStateVO {
    ...
    private UdpIncidentReceiveStateContentVO  msgContent;
    ...
    @XmlTransient
    public UdpIncidentReceiveStateContentVO getMsgContent() {
        return msgContent;
    }

    public void setMsgContent(UdpIncidentReceiveStateContentVO msgContent) {
